...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("GOM Remoto".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["remoto.nubegom.com"];
pub const RS_PUB_KEY: &str = "U0B5ncn5VkSrHFMQ6sOM9717abQjrKX9sbTlXrvOF8c=";
