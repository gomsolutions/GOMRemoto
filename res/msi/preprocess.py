...
g_arpsystemcomponent = {
    ...
    "Contact": {
        "msi": "ARPCONTACT",
        "v": "https://github.com/gomsolutions/GOMRemoto",
    },
    "HelpLink": {
        "msi": "ARPHELPLINK",
        "v": "https://github.com/gomsolutions/GOMRemoto/issues/",
    },
    "ReadMe": {
        "msi": "ARPREADME",
        "v": "https://github.com/gomsolutions/GOMRemoto",
...
def make_parser():
    ...
    parser.add_argument(
        "--app-name", type=str, default="GOM Remoto", help="The app name."
    )
    parser.add_argument(
