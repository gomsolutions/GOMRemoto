...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ansluter till GOM Remoto..."),
        ...
        ("install_tip", "På grund av UAC, kan inte GOM Remoto fungera ordentligt på klientsidan. För att undvika problem med UAC, tryck på knappen nedan för att installera GOM Remoto på systemet."),
        ("Click to upgrade", "Klicka för att nedgradera"),
        ("Configure", "Konfigurera"),
        ("config_acc", "För att kontrollera din dator på distans måste du ge GOM Remoto \"Tillgänglighets\" rättigheter."),
        ("config_screen", "För att kontrollera din dator på distans måste du ge GOM Remoto \"Skärminspelnings\" rättigheter."),
        ...
        ("android_input_permission_tip2", "Gå till systeminställningarna, hitta [Installed Services], sätt på [GOM Remoto Input] tjänsten."),
        ...
        ("Turned off", "Avstängd"),
        ("Language", "Språk"),
        ("Keep GOM Remoto background service", "Behåll GOM Remoto i bakgrunden"),
        ("Ignore Battery Optimizations", "Ignorera batterioptimering"),
        ("android_open_battery_optimizations_tip", "Om du vill stänga av denna funktion, gå till nästa GOM Remoto programs inställningar, hitta [Batteri], Checka ur [Obegränsad]"),
        ...
        ("Show GOM Remoto", "Visa GOM Remoto"),
        ("This PC", "Denna dator"),
        ("or", "eller"),
        ("Elevate", "Höj upp"),
        ("Zoom cursor", "Zoom"),
