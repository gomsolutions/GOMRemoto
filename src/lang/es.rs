...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conexión a la red GOM Remoto en progreso..."),
        ...
        ("install_tip", "Debido al Control de cuentas de usuario, es posible que GOM Remoto no funcione correctamente como escritorio remoto. Para evitar este problema, haga clic en el botón de abajo para instalar GOM Remoto a nivel de sistema."),
        ("Click to upgrade", "Clic para actualizar"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar su escritorio desde el exterior, debe otorgar permiso a GOM Remoto de \"Accesibilidad\"."),
        ("config_screen", "Para controlar su escritorio desde el exterior, debe otorgar permiso a GOM Remoto de \"Grabación de pantalla\"."),
        ...
        ("android_input_permission_tip1", "Para que un dispositivo remoto controle su dispositivo Android a través del ratón o toque, debe permitir que GOM Remoto use el servicio de \"Accesibilidad\"."),
        ("android_input_permission_tip2", "Vaya a la página de configuración del sistema que se abrirá a continuación, busque y acceda a [Servicios instalados], active el servicio [GOM Remoto Input]."),
        ...
        ("Turned off", "Apagado"),
        ("Language", "Idioma"),
        ("Keep GOM Remoto background service", "Dejar GOM Remoto como Servicio en 2do plano"),
        ...
        ("Show GOM Remoto", "Mostrar GOM Remoto"),
        ("This PC", "Este PC"),
        ("or", "o"),
        ...
        ("config_input", "Para controlar el escritorio remoto con el teclado necesitas dar a GOM Remoto permisos de \"Monitorización de entrada\"."),
        ("config_microphone", "Para poder hablar de forma remota necesitas darle a GOM Remoto permisos de \"Grabar Audio\"."),
        ...
        ("verify_rustdesk_password_tip", "Verificar la contraseña de GOM Remoto"),
        ...
        ("scam_text1", "Si estás al teléfono con alguien a quien NO conoces y en quien NO confías y te ha pedido que uses GOM Remoto e inicies el servicio, no lo hagas y cuelga inmediatamente."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "¡Por favor, actualiza GOM Remoto Server Pro a la versión {} o superior"),
        ...
        ("selinux_tip", "SELinux está activado en tu dispositivo, lo que puede hacer que GOM Remoto no se ejecute correctamente como lado controlado."),
        ...
        ("powered_by_me", "Con tecnología de GOM Remoto"),
        ...
        ("floating_window_tip", "Ayuda a mantener el servicio de GOM Remoto de fondo"),
        ...
        ("About GOM Remoto", "Acerca de GOM Remoto"),
        ...
        ("Accessible devices", ""),
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Por favor, actualiza el cliente GOM Remoto a la versión {} o superior en el lado remoto"),
