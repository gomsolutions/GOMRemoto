...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Yhdistetään GOM Remoto verkkoon..."),
        ...
        ("install_tip", "Joissain tapauksissa GOM Remoto ei toimi oikein etäpuolella UAC:n vuoksi. Välttääksesi tämän, napsauta alla olevaa painiketta asentaaksesi GOM Remotoin järjestelmään."),
        ("Click to upgrade", "Päivitä napsauttamalla"),
        ("Configure", "Määritä"),
        ("config_acc", "Etätyöpöydän hallintaa varten sinun on annettava GOM Remotoille ”Esteettömyys”-oikeudet."),
        ("config_screen", "Etätyöpöydän käyttöä varten sinun on annettava GOM Remotoille ”Näytön tallennus” oikeudet."),
        ...
        ("Discovered", "Löydetty"),
        ("install_daemon_tip", "Palvelun automaattista käynnistystä varten GOM Remoto daemon on asennettava järjestelmään."),
        ("Remote ID", "Etätunnus"),
        ("Paste", "Liitä"),
        ...
        ("android_input_permission_tip1", "Siirry Androidin asetuksiin ja ota GOM Remotoille käyttöön 'Syötteen ohjaus' oikeus."),
        ("android_input_permission_tip2", "Jos et löydä asetusta, etsi 'Esteettömyys' ja salli GOM Remoto ohjelman käyttö."),
        ("android_new_connection_tip", "Uusi yhteyspyyntö vastaanotettu."),
        ("android_service_will_start_tip", "GOM Remoto palvelu käynnistyy taustalla."),
        ("android_stop_service_tip", "Pysäytä taustapalvelu tarvittaessa GOM Remotoin asetuksista."),
        ("android_version_audio_tip", "Äänensiirto vaatii Android 10:n tai uudemman."),
        ("android_start_service_tip", "GOM Remoto palvelu käynnistetään..."),
        ...
        ("Language", "Kieli"),
        ("Keep GOM Remoto background service", "Pidä GOM Remotoin taustapalvelu käynnissä"),
        ("Ignore Battery Optimizations", "Ohita akun optimoinnit"),
        ("android_open_battery_optimizations_tip", "Poista GOM Remotoin akkuoptimointi, jotta yhteys pysyy vakaana taustalla."),
        ...
        ("Show GOM Remoto", "Näytä GOM Remoto"),
        ...
        ("verify_rustdesk_password_tip", "Vahvista GOM Remoto salasanasi kirjautumista varten"),
        ...
        ("scam_text2", "GOM Remoto ei koskaan pyydä maksua tai etäkäyttöä ilman lupaasi."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Päivitä GOM Remoto Server Pro versioon {} jatkaaksesi."),
        ...
        ("About GOM Remoto", "Tietoa GOM Remotoistä"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Päivitä etä-GOM Remoto-asiakasversioon {} yhteensopivuuden takaamiseksi"),
