...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Đang kết nối đến mạng lưới GOM Remoto..."),
        ...
        ("install_tip", "Do cơ chế UAC, GOM Remoto có thể không hoạt động ổn định ở phía người dùng từ xa trong một số trường hợp. Để tránh vấn đề này, vui lòng nhấn nút bên dưới để cài đặt GOM Remoto vào hệ thống."),
        ("Click to upgrade", "Nhấn để nâng cấp"),
        ("Configure", "Cấu hình"),
        ("config_acc", "Để điều khiển từ xa, bạn cần cấp quyền \"Trợ năng\" cho GOM Remoto."),
        ("config_screen", "Để truy cập từ xa, bạn cần cấp quyền \"Ghi màn hình\" cho GOM Remoto."),
        ...
        ("android_input_permission_tip2", "Vui lòng tìm [Dịch vụ đã cài đặt] trong cài đặt và bật [GOM Remoto Input]."),
        ...
        ("Turned off", "Đã tắt"),
        ("Language", "Ngôn ngữ"),
        ("Keep GOM Remoto background service", "Giữ dịch vụ GOM Remoto chạy nền"),
        ...
        ("Show GOM Remoto", "Hiện GOM Remoto"),
        ...
        ("verify_rustdesk_password_tip", "Xác thực mật khẩu GOM Remoto"),
        ...
        ("scam_text2", "Chỉ sử dụng GOM Remoto với những người bạn thực sự tin tưởng."),
        ...
        ("allow-only-conn-window-open-tip", "Chỉ cho phép khi cửa sổ GOM Remoto mở"),
        ...
        ("floating_window_tip", "Giữ GOM Remoto trên cùng"),
        ...
        ("About GOM Remoto", "Về GOM Remoto"),
